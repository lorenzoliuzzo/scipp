/**
 * @file    benchmark/measurement.cpp
 * @author  Lorenzo Liuzzo (lorenzoliuzzo@outlook.com)
 * @brief   This file contains the benchmarking of the scipp::math::op function on the scipp::physics::measurement type.
...
constexpr measurement<base::time> a = 5.0;
constexpr measurement<base::time> b = 10.0;
