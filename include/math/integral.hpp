    ...
    class integral {
        ...
        public:
            ...
            template <typename FUNCTION_TYPE> 
                requires (math::is_unary_function_v<FUNCTION_TYPE>)
            static constexpr auto midpoint(FUNCTION_TYPE&& f, 
                                           typename FUNCTION_TYPE::argument_type from_a,
                                           typename FUNCTION_TYPE::argument_type to_b,
                                           size_t steps = 1000) noexcept 

                -> op::measurements_prod_t<typename FUNCTION_TYPE::argument_type, typename FUNCTION_TYPE::result_type> {

                const typename FUNCTION_TYPE::argument_type increment = op::abs(to_b - from_a) / static_cast<physics::scalar_m>(steps);
                typename FUNCTION_TYPE::result_type total_sum = f(from_a);
            ...
            static constexpr auto midpoint(FUNCTION_TYPE&& f, 
                                           typename FUNCTION_TYPE::first_argument_t fixed_arg,
                                           typename FUNCTION_TYPE::second_argument_t from_a,
                                           typename FUNCTION_TYPE::second_argument_t to_b,
                                           size_t steps = 1000) noexcept 

                -> op::measurements_prod_t<typename FUNCTION_TYPE::result_t, typename FUNCTION_TYPE::second_argument_t> {

                const typename FUNCTION_TYPE::second_argument_t increment = op::abs(to_b - from_a) / static_cast<physics::scalar_m>(steps);
            ...
            //                               const MEAS1 from_a,
            //                               const MEAS1 to_b,
            //                               const size_t& steps = 1000) noexcept -> op::measurements_prod_t<MEAS1, MEAS2> {
