...
namespace scipp {
    ...
    namespace geometry {
        ...
        namespace linear_algebra {
            ...
            template <template <unit_base UB> class<UB>... measurements, std::size_t ROWS, std::size_t COLS>
            class matrix2 {


                public:

                    using measurement = measurement<measurements...>;

                    using unit_base = typename measurement::unit_base;

                    using vector = vector<measurements...>;

                    using matrix = matrix<measurements..., ROWS, COLS>;
