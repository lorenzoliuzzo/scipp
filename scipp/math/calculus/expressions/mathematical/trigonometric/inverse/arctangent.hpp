/**
 * @file    scipp/math/calculus/expressions/mathematical/trigonometric/arctangent.hpp
 * @author  Lorenzo Liuzzo (lorenzoliuzzo@outlook.com)
 * @brief   This file contains the implementation of the arctangent expression
 * @date    2023-07-15
 * 
...
namespace scipp::math {
    ...
    namespace calculus {
        ...
        struct arctangent_expr : unary_expr<T, T> {
            ...
            constexpr arctangent_expr(const T& v, auto e) noexcept : unary_expr<T, T>(v, e) {}
