 ...
 * @brief   This file contains the implementation of the function struct.
 * @date    2023-07-16
 * 
    ...
    namespace calculus {    
        ...
        struct function {
            ...
            constexpr function(function& func) noexcept :
                ...
                f(func.f), variables(func.variables) {}
        ...
        template <typename RANGE, typename DOMAIN>
        using unary_function = function<RANGE, DOMAIN>; 

        template <typename RANGE, typename DOMAIN1, typename DOMAIN2>
        using binary_function = function<RANGE, DOMAIN1, DOMAIN2>;
