...
namespace scipp::math {
    ...
    namespace op {
        ...
        inline constexpr complex<MEAS_TYPE1> polar(const MEAS_TYPE1& rho, const MEAS_TYPE2& theta) noexcept {
        ...
        template <typename MEAS_TYPE>
            requires (physics::is_generic_measurement_v<MEAS_TYPE> && physics::is_scalar_v<MEAS_TYPE>)
        inline constexpr auto log10(const complex<MEAS_TYPE>& other) noexcept {
        ...
        template <typename MEAS_TYPE>
            requires (physics::is_generic_measurement_v<MEAS_TYPE> && physics::is_scalar_v<MEAS_TYPE>)
        inline constexpr auto tan(const complex<MEAS_TYPE>& other) noexcept {
        ...
        template <typename MEAS_TYPE>
            requires (physics::is_generic_measurement_v<MEAS_TYPE> && physics::is_scalar_v<MEAS_TYPE>)
        inline constexpr auto tanh(const complex<MEAS_TYPE>& other) noexcept {
        ...
        template <typename MEAS_TYPE, typename SCALAR_TYPE>
            requires (physics::is_generic_measurement_v<MEAS_TYPE> && physics::is_scalar_v<MEAS_TYPE>)
        inline static constexpr auto pow(const complex<MEAS_TYPE>& x, const SCALAR_TYPE& y) {
        ...
        template <typename MEAS_TYPE>
            requires (physics::is_generic_measurement_v<MEAS_TYPE>)
        inline static constexpr auto pow(const complex<MEAS_TYPE>& x, const complex<MEAS_TYPE>& y) {
