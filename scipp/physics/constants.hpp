...
namespace scipp::physics {
    ...
    namespace constants {
        ...
        inline static constexpr measurement G(6.67430e-23, N * sq_m / op::square(kg)); ///< gravitational constant
        
        inline static constexpr measurement c(299792458, m / s); ///< speed of light in vacuum
        ...
        // inline static constexpr measurement mu0(1.25663706212e-6, N / sq_A); ///< magnetic permeability of vacuum
        ...
        inline static constexpr measurement m_e(9.1093837015e-31, kg); ///< electron mass

        inline static constexpr measurement m_p(1.67262192369e-27, kg); ///< proton mass

        inline static constexpr measurement m_n(1.67492749804e-27, kg); ///< neutron mass
