...
namespace scipp::physics {
    ...
    struct spring_potential : potential<measurement<units::newton_per_metre>, measurement<units::metre>> {
        ...
        spring_potential(const measurement<units::newton_per_metre>& k, const measurement<units::metre>& l0) noexcept 
    ...
    struct gravitational_potential : potential<measurement<units::kilogram>, measurement<units::kilogram>> {

        gravitational_potential(const measurement<units::kilogram>& m1, const measurement<units::kilogram>& m2) noexcept 
