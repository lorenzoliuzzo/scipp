...
namespace scipp::physics {
    ...
    // =============================================
        ...
        template <typename BASE1, typename BASE2> 
            requires (are_base_v<BASE1, BASE2>)
        struct base_prod : public base_quantity<BASE1::length_power + BASE2::length_power, 
                                                BASE1::time_power + BASE2::time_power,
                                                BASE1::mass_power + BASE2::mass_power,
                                                BASE1::temperature_power + BASE2::temperature_power,
                                                BASE1::substance_amount_power + BASE2::substance_amount_power,
        ...
        template <typename BASE1, typename BASE2> 
            requires (are_base_v<BASE1, BASE2>)
        struct base_div : public base_quantity<BASE1::length_power - BASE2::length_power, 
                                               BASE1::time_power - BASE2::time_power,
                                               BASE1::mass_power - BASE2::mass_power,
                                               BASE1::temperature_power - BASE2::temperature_power,
                                               BASE1::substance_amount_power - BASE2::substance_amount_power,
        ...
        template <typename BASE, int POWER> 
            requires (is_base_v<BASE>)
        struct base_pow : public base_quantity<BASE::length_power * POWER, 
        ...
        template <typename BASE, int POWER> 
            requires (has_valid_root_v<BASE, POWER>)
        struct base_root : public base_quantity<BASE::length_power / POWER, 
                                                BASE::time_power / POWER,
                                                BASE::mass_power / POWER,
                                                BASE::temperature_power / POWER,
                                                BASE::substance_amount_power / POWER,
        ...
        template <typename BASE> 
            requires (is_base_v<BASE>)
        struct base_inv : public base_quantity<-BASE::length_power, 
                                               -BASE::time_power,
                                               -BASE::mass_power,
