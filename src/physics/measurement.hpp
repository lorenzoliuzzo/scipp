...
namespace scipp::physics {
    ...
    struct measurement {
        ...
        // ==============================================
            ...
            /// @brief Multiply this measurement and another measurement
            ...
            /// @brief Divide this measurement and another measurement
            /// @note The denominator must not be zero
            template <typename OTHER_BASE_TYPE> 
                requires (is_base_v<OTHER_BASE_TYPE>)
            constexpr auto operator/=(const measurement<OTHER_BASE_TYPE>& other) 
            ...
            template <typename OTHER_BASE_TYPE> 
                requires (is_base_v<OTHER_BASE_TYPE>)
            constexpr auto operator/=(measurement<OTHER_BASE_TYPE>&& other) 
                -> measurement<math::op::base_division_t<BASE_TYPE, OTHER_BASE_TYPE>>& {
