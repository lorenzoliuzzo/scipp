...
namespace scipp::physics {
    ...
    /// =================================================
        ...
        static constexpr hectometre hm; ///< hm unit

        using decametre = unit<metre, std::deca>; ///< decametre unit
        static constexpr decametre dam; ///< dam unit
