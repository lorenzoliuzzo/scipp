...
struct myFUNC : functions::unary_function<op::square_t<typename VECTOR_TYPE::measurement_t>, VECTOR_TYPE> {

    constexpr op::square_t<typename VECTOR_TYPE::measurement_t> operator()(const VECTOR_TYPE& other) const noexcept override {
...
template <typename VECTOR_TYPE>
    requires (is_vector_v<VECTOR_TYPE>)
struct myFUNC2 : functions::unary_function<op::invert_t<typename VECTOR_TYPE::measurement_t>, VECTOR_TYPE> {

    constexpr op::invert_t<typename VECTOR_TYPE::measurement_t> operator()(const VECTOR_TYPE& other) const noexcept override {
