...
namespace scipp::math {
    ...
    inline static constexpr T3 hermite_next(const size_t& N, const T1& x, const T2& H_n_minus_1, const T3& H_n_minus_2) noexcept {
    ...
    template <typename T>
    static constexpr T hermite(size_t N, const T& x) noexcept {
