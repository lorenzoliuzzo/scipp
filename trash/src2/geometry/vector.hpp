...
namespace scipp::geometry {
    ...
    struct vector2 {
        ...
        // ===========================================================
            ...
            /// @param other: geometry::vector2<DIM, MEAS_TYPES...> as l-value const reference
            /// @return geometry::vector2<DIM, MEAS_TYPES...>&
            constexpr 
                vector2<DIM, MEAS_TYPES...>& operator+=(const vector2& other) 
            noexcept 
            {
            ...
            // /// @return geometry::vector2<DIM, MEAS_TYPES... * measurement>&
            ...
            // constexpr 
            //     auto operator*(const MEAS_TYPE& other)
            // const noexcept 
            //     -> vector2<DIM, physics::multiply_each_t<MEAS_TYPE, MEAS_TYPES...>>
            // {

            //     vector2<DIM, physics::multiply_each_t<MEAS_TYPE, MEAS_TYPES...>> result;
        ...
        // ===========================================================
            ...
            constexpr 
                const std::tuple<MEAS_TYPES...>& data() 
            const noexcept 
            {
    ...
    template <typename... MEAS_TYPES> 
        requires (scipp::physics::are_measurements_v<MEAS_TYPES...>)
    vector2(MEAS_TYPES&&... measurements) 
    ...
    template <typename... MEAS_TYPES> 
        requires (scipp::physics::are_measurements_v<MEAS_TYPES...>)
    inline constexpr 
        auto make_vector2(MEAS_TYPES&&... measurements) 
    noexcept 
        -> vector2<sizeof...(MEAS_TYPES), MEAS_TYPES...> 
    {
    ...
    template <size_t DIM, typename... MEAS_TYPES> 
        requires (scipp::physics::are_measurements_v<MEAS_TYPES...> && (DIM == sizeof...(MEAS_TYPES)))
    inline constexpr 
        auto make_vector2(MEAS_TYPES&&... measurements) 
    noexcept 
        -> vector2<DIM, MEAS_TYPES...>         
    {
    ...
    template <typename... Ts>
    constexpr bool are_vectors2_v = are_vectors2<Ts...>::value;
    ...
    // template <typename... Ts>
    // constexpr bool are_same_vectors2_v = are_same_vectors2<Ts...>::value;
    ...
    struct vector {
        ...
        // ===========================================================
            ...
            noexcept 
                requires (physics::are_measurements_v<MEAS...> && (sizeof...(measurements) == DIM)) : 
             ...
             */
            template <typename... MEAS>
            constexpr vector(MEAS&&... measurements) 
            noexcept requires (physics::are_measurements_v<MEAS...> && (sizeof...(measurements) == DIM)) : 
             ...
             */
            constexpr vector(const std::array<value_type, DIM>& other) 
            noexcept : 
             ...
             */
            constexpr vector(std::array<value_type, DIM>&& other) 
            noexcept : 
        ...
        // ===========================================================
             ...
             */
            constexpr std::array<value_type, DIM>& data() 
            noexcept 
            {
             ...
             * @return const std::array<value_type, DIM>&: vector components
             */
            constexpr const std::array<value_type, DIM>& data() const noexcept 
            {
    ...
    template <typename... VECTORS>
    constexpr size_t common_dimention_v = common_dimention<VECTORS...>::value;
