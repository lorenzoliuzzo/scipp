...
std::vector<double> bench_meta_measurement_sum(const size_t& n) {
...
std::vector<double> bench_meta_measurement_prod(const size_t& n) {
...
std::vector<double> bench_meta_measurement_div(const size_t& n) {
